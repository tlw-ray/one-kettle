...
public class TextFileInputTest {
  ...
  public void testClose() throws Exception {
    ...
    TextFileInputMeta mockTFIM = createMetaObject( (BaseFileField[])null );
    String virtualFile = createVirtualFile( "pdi-17267.txt", (String[])null );
    TextFileInputData mockTFID = createDataObject( virtualFile, ";", (String[])null );
