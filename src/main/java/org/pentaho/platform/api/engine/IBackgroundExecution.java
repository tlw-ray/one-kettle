...
public interface IBackgroundExecution {
  ...
  String BACKGROUND_ACTION_NAME_STR = "background_action_name"; //$NON-NLS-1$

  String BACKGROUND_SUBMITTED = "background_submit_time"; //$NON-NLS-1$

  String DEFAULT_USER_NAME = "SYSTEM"; //$NON-NLS-1$
   ...
   */
  IOutputHandler getContentOutputHandler(String location, String fileName, String solutionName,
