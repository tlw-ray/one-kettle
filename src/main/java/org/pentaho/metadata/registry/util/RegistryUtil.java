...
public class RegistryUtil {
   ...
   * @param documentIdOrPath
   *          The document id or document path
   * @return
   */
   ...
   * 
   * @param parts
   *          Parts of an id to be joined together to form a single id
  ...
  /**
   * Returns an entity representing a database table. The entity is retrieved from the registry. If 'create' is false,
   * returns null if the entity does not exist in the registry. If it is true, the entity will be created if it does not
   * exist. If the entity is created the registry will be be committed, the caller needs to commit the registry.
   * 
   * @param databaseName
   * @param schemaName
   * @param tableName
  ...
  /**
   * Modifies a numeric entity attribute by adding an offset to it. If the attribute does not exist, its initial value
   * is set to the offset. The entity must exist in the registry.
   * 
   * @param entityId
   * @param typeId
   * @param attrId
